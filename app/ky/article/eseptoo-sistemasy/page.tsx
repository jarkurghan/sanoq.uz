...
export function generateMetadata(): Metadata {
    ...
    const title = "Эсептөө системалары — жалпы кароо, тарыхы жана түрлөрү";
    const description =
        ...
        <main className="flex">
            <article className="flex-1 text-justify">
                <Container className="prose prose-lg">
                    <header>
                        <h1>Эсептөө системасы</h1>
                    </header>
                    <section>
                        <h2 className="hidden">Эсептөө системасы</h2>
                        <p>
                            Эсептөө системасы — сандарды жазуу жолу, башкача айтканда, белгилүү бир сандар жыйынын белгилер же цифралар аркылуу иреттүү жана
                            бирдей тартипте көрсөтүүгө кызмат кылган математикалык жазуу системасы.
                        </p>
                        <p>
                            Бир эле белгилер тизмеги ар кандай эсептөө системаларында ар башка маанини бере алат. Мисалы,{" "}
                            <code className="[font-family:'Times_New_Roman',serif] px-1 py-0.5 rounded">"11"</code> ондук эсептөө системасында (азыр дүйнөдө эң
                            көп колдонулган) он бирди билдирет, экилик эсептөө системасында (заманбап компьютерлерде колдонулат) үчтү, ал эми бирдик эсептөө
                            системасында (саноо-таяк ыкмасында) экөөнү көрсөтөт.
                        </p>
                        <p>
                            Белгинин билдирген саны анын <strong>мааниси</strong> деп аталат. Бардык эсептөө системалары бирдей сандар жыйынын көрсөтө албайт;
                            мисалы, Рим, Грек жана Египет цифраларында нөлгө арналган белги болгон эмес.
                        </p>
                        <p>Идеалдуу эсептөө системасы төмөнкү шарттарга ээ болушу керек:</p>
                        <ul>
                        ...
                        <p>
                            Мисалы, кадимки ондук эсептөө системасында нөлгө тең эмес ар бир натуралдык сан башында нөл эмес цифрадан башталган чектелген цифралар
                            тизмеги аркылуу өзгөчө түрдө көрсөтүлөт.
                        </p>
                        <p>
                            Айрым учурда эсептөө системаларын <em>сан системалары</em> деп да аташат. Бирок бул аталыш так эмес, анткени ал башка математикалык
                    ...
                    <section>
                        <h2>Тарых</h2>
                        <p>
                            Окумуштуулардын айтымында, алгачкы эсептөө системалары ар кайсы цивилизациялардын ичинде ар түрдүү болгон: вавилондуктар 60-дык
                        ...
                        <p>
                            ...
                            бул идеяларды өркүндөтүшкөн. Эсептөө системалары өнүккөн сайын, позициялык жазуунун ыңгайлуулугу жана нөлдүн кошулушу азыркы сан
                            жазуунун түзүлүшүнө, дүйнөлүк соода, илим жана технологияга зор таасир эткен.
                        </p>
                        <p>
                            Биринчи чыныгы жазма позициялык эсептөө системасы <strong>индия–араб эсептөө системасы</strong> болуп эсептелет. Бул система VII кылымда
                            Индияда түзүлгөн
                    ...
                    <section>
                        <h2>Сандарды колдонгон башка тарыхый эсептөө системалары</h2>
                        <Image
                            src="/images/maya.png"
                        ...
                        />
                        <p>
                            <strong>Майя сандарынын</strong> так жашы белгисиз, бирок алардын индия–араб системасынан да эски болушу мүмкүн. Бул система{" "}
                        ...
                        <p>
                            <strong>Тай сандары</strong> индия–араб эсептөө системасына окшош, айырмасы — колдонулган белгилер башкача. Бул белгилер азыр
                    ...
                    <section>
                        <h2>Негизги эсептөө системалары</h2>
                        <p>
                            Эң көп колдонулган эсептөө системасы — ондук (decimal) система. Анын бүтүн сандык версиясын иштеп чыгууда индиялык математиктер, атап
                            айтканда
                        ...
                        <p>
                            ...
                            катары <code>/</code> тандасак, жети саны /////// түрүндө жазылат. Эсеп сызыктары (tally marks) ушундай системанын азыркыга чейин
                        ...
                        <p>
                            Компьютерлерде негизги система — 2 негиздүү позициялык система (экилик). Ал болгону эки цифрага — 0 жана 1ге таянат. Экиликти үчтөн
                            топтоо аркылуу 8 негиздүү (сегиздик), төрттөн топтоо аркылуу 16 негиздүү (он алтылык) системалар алынат. Өтө чоң бүтүн сандар үчүн 2³²
                        ...
                        <p>
                            Информатикада кээде <em>биектив эсептөө</em> деп аталган өзгөртүлгөн <em>k</em>-негиздүү система колдонулат. Анда цифралар 1, 2, …,{" "}
