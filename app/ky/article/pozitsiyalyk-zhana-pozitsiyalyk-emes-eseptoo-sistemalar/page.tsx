...
export function generateMetadata(): Metadata {
    ...
    const title = "Позициялык жана позициялык эмес эсептөө системалары";
    const description = "Бул макала эсептөө системалары түшүнүгүн жөнөкөй жана колдонмолуу мисалдар менен түшүндүрөт.";
    const keywords = ["эсептөө системасы", "позициялык эсептөө системасы", "позициялык эмес эсептөө системасы", "рим цифралары", "эсептөө системаларынын айырмасы"];
        ...
        <main className="flex">
            <article className="flex-1 text-justify">
                <Container className="prose prose-lg">
                    <header>
                        <h1>Позициялык жана позициялык эмес эсептөө системалары</h1>
                        <p>
                            Бул макала эсептөө системалары түшүнүгүн жөнөкөй жана колдонмолуу мисалдар менен түшүндүрөт. Негизги көңүл эки чоң категорияга
                    ...
                    <section>
                        <h2>Эсептөө системасы деген эмне?</h2>
                        <p>
                            Эсептөө системасы — бул <em>сандарды белгилөө жана жазуу эрежелеринин</em> жыйындысы. Ар бир системанын <strong>негизи</strong> жана{" "}
                    ...
                    <section>
                        ...
                        <ul>
                            ...
                            <li>
                                <strong>Байыркы мисир цифралары:</strong> бирдик, ондук, жүздүк белгилеринин кайталоочу кошундусу менен сан жазылат (позиция
                                маанилүү эмес).
                            </li>
                        </ul>
                        <p>
                    ...
                    <section>
                        ...
                        <ul>
                            ...
                            <li>
                                <strong>Сегиздик (b=8) жана он алтылык (b=16):</strong> бит топторун ыкчам көрсөтүү үчүн, программалоодо ыңгайлуу.
                            </li>
                            <li>
                                <strong>Алтылык (b=6), бештик (b=5), жыйырмалык (b=20), алтымыштык (b=60):</strong> ар кыл маданияттарда жана тарыхый
                    ...
                    <section>
                        ...
                        <ul>
                            ...
                            <li>
                                <strong>Бөлчөк которуусун эрте токтотуу:</strong> катага көз салуу үчүн кадам санын жана тактыкты алдын ала белгилеп алуу
                                керек.
                            </li>
                            <li>
                    ...
                    <section>
                        <p>
                            ...
                            алгоритмдик арифметика. Которуу ыкмаларын билүү программалоо менен инженердик күнүмдүк ишти жеңилдетет.
                        </p>
                    </section>
