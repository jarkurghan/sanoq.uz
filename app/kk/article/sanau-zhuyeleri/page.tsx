        ...
        <main className="flex">
            <article className="flex-1 text-justify">
                <Container className="prose prose-lg">
                    ...
                    <section>
                        <h2 className="hidden">Санау жүйесі</h2>
                        <p>
                            Санау жүйесі — сандарды жазбаша түрде бейнелеу тәсілі, яғни белгілі бір сандар жиынын цифрлар немесе таңбалар арқылы бірізді әрі
                            жүйелі түрде көрсетуге арналған математикалық жазу жүйесі.
                        </p>
                        <p>
                            Бірдей таңбалар тізбегі әртүрлі санау жүйелерінде әртүрлі мағына беруі мүмкін. Мысалы,{" "}
                            <code className="[font-family:'Times_New_Roman',serif] px-1 py-0.5 rounded">"11"</code> жазуы ондық санау жүйесінде (бүгінде
                            дүниежүзінде ең көп қолданылатыны) он бірді білдіреді, екілік санау жүйесінде (заманауи компьютерлерде қолданылады) үшті, ал
                            бірлік санау жүйесінде (қол санақта) екіні көрсетеді.
                        </p>
                        <p>
                            Таңбаның білдіретін саны оның <strong>мәні</strong> деп аталады. Барлық санау жүйелері бірдей сандар жиынын көрсете алмайды;
                            мысалы, Рим, Грек және Мысыр цифрларында нөл үшін арнайы таңба жоқ.
                        </p>
                        <p>Идеалды санау жүйесі мынадай болуы керек:</p>
                        <ul>
                        ...
                        <p>
                            Мысалы, кәдімгі ондық санау жүйесінде нөлден басқа кез келген натурал сан басында нөл емес цифрдан басталатын шектеулі цифрлар
                            тізбегі арқылы бірегей түрде көрсетіледі.
                        </p>
                        <p>
                            Кейде санау жүйелерін <em>сан системалары</em> деп те атайды. Бірақ бұл атау нақты емес, өйткені ол басқа да математикалық
                    ...
                    <section>
                        <h2>Тарих</h2>
                        <p>
                            Ғалымдардың айтуынша, алғашқы санау жүйелері әр өркениетте әртүрлі болған: вавилондықтар 60-тық жүйені қолданған, мысырлықтар
                            иероглифтік сандарды дамытқан, қытайлықтар таяқша сандарын пайдаланған. Майялар өз бетінше 20-лық (висизимал) жүйені жасап, онда
                        ...
                        <p>
                            ...
                            жетілдірді. Санау жүйелері дамыған сайын, позициялық жазудың тиімділігі мен нөлдің енгізілуі қазіргі заманғы сандық жазудың
                            қалыптасуына, сондай-ақ әлемдік сауда, ғылым мен технологияға үлкен әсер етті.
                        </p>
                        <p>
                            Алғашқы нағыз жазба позициялық санау жүйесі <strong>үнді–араб санау жүйесі</strong> болып саналады. Бұл жүйе VII ғасырда
                        ...
                        <p>
                            ...
                            қарағанда осы жүйені таңдады. XV ғасыр соңына қарай олар күнделікті өмірде кеңінен қолданылды
                        ...
                        <p>
                            XVII ғасырда бұл жүйе ғылыми еңбектерде үстемдік етіп, <strong>Исаак Ньютон</strong>
                    ...
                    <section>
                        <h2>Сандарды қолданған басқа тарихи санау жүйелері</h2>
                        <Image
                            src="/images/maya.png"
                        ...
                        />
                        <p>
                            <strong>Майя сандарының</strong> нақты жасы белгісіз, бірақ олардың үнді–араб санау жүйесінен де көне болуы мүмкін. Бұл жүйе{" "}
                            <em>висизимал</em> (20-лық) болып, жиырма таңбадан тұрған. Майялар нөлді бейнелеу үшін қабықша символын қолданған. Сандар тік
                            жазылып, бірліктер төменгі қатарға орналастырылған. Майяларда қазіргі ондық бөлгішке ұқсас белгі болмағандықтан, олардың жүйесі
                            бөлшек сандарды көрсете алмаған.
                        </p>
                        <p>
                            <strong>Тай сандары</strong> үнді–араб санау жүйесіна ұқсас, тек таңбалары өзгеше. Бұл таңбалар қазіргі Таиландта бұрынғыдай жиі
                        ...
                        />
                        <p>
                            <strong>Таяқша сандар</strong> — қытай және жапон математиктері қолданған жазба түрі, ондық позициялық жүйе ретінде ондық
                            есептеулерде пайдаланылған. Таяқшалар санау тақтасына қойылып, алға не артқа жылжыту арқылы ондық разряд өзгертілген.
                        </p>
                        <p>
                            Б.з. III–V ғасырларына жататын <em>Sūnzĭ Suànjīng</em> атты математикалық еңбек бұл жүйені егжей-тегжейлі сипаттайды.
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            белгі ретінде <code>/</code> таңдалса, жеті саны /////// түрінде жазылады. Санау сызықшалары (tally marks) — осындай жүйенің бүгінге
                        ...
                        <p>
                            Компьютерлерде басты жүйе — негізі 2 болатын позициялық екілік санау жүйесі. Ол екі цифрға — 0 және 1-ге сүйенеді. Екілік сандарды
                            үштікке топтау арқылы сегіздік (негізі 8), төрттікке топтау арқылы он алтылық (негізі 16) жүйелер алынады. Өте үлкен бүтін сандар үшін
                            2³² немесе 2⁶⁴ негізді жүйелер қолданылады.
                        </p>
                        <p>
                        ...
                        <p>
                            Информатикада кейде <em>биективті санау жүйесі</em> деп аталатын өзгертілген <em>k</em>-негізді жүйе қолданылады. Онда цифрлар 1, 2, …,{" "}
                            <em>k</em> болып, нөл бос жолмен көрсетіледі. Бұл жүйе барлық сандар мен цифрлар жолдары арасында бірмәнді сәйкестік орнатады.
                            Биективті 1-негізді жүйе — бірлік жүйесіне тең.
                        </p>
                    </section>
